...
export default function EditCropModal({ onClose, onSubmit, loading, selectedCrop }) {
  ...
  const validate = () => {
    ...
    const noChangesError = validators.validateNoChanges(selectedCrop, form,
      ["CropName", "Category", "Season", "AverageYieldPerHectare", "MarketPrice"]
    );
  ...
  return (
    <Modal title="Edit Crop" onClose={onClose} width="max-w-lg">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 -mt-4 mb-3">
        Update the crop's information below.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-sm">
        ...
        <div>
          ...
          <input name="CropName" value={form.CropName} onChange={handleChange} className={modalInput} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <select name="Category" value={form.Category} onChange={handleChange} className={modalInput}>
          ...
          <div>
            ...
            <select name="Season" value={form.Season} onChange={handleChange} className={modalInput}>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <input type="number" step="0.01" name="AverageYieldPerHectare" value={form.AverageYieldPerHectare} onChange={handleChange} className={`${modalInput} dark:[color-scheme:dark]`} />
          </div>
          <div>
